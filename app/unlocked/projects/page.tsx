...
export default function Page() {
  ...
  return (
    <main className="flex px-2 flex-col   h-full bg-[#272727] relative">
      <div className="max-h-[460px] overflow-scroll">
          ...
          <tbody>
            {repos.map((repo, i) => (
              <tr className="text-sm hover:bg-white/30" key={i} >
                ...
                <td style={{ maxWidth: '200px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }} className="py-2">{repo.topics.join(", ")}</td>
                <td className="py-2">
